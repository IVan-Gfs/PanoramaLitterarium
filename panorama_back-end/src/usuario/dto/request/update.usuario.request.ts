...
export class UpdateUsuarioResquest {

  @IsNumber()
  idUsuario?: number;

  @IsOptional({message: 'Nome de usuário é obrigatório'})
  ...
  @IsOptional({ message: 'A senha é obrigatória.' })
  ...
  @IsOptional({ message: 'O tipo de usuário é obrigatório.' })
  ...
  constructor(data: Partial<UpdateUsuarioResquest> = {}){
